...
export default function FAQ() {
  ...
  return (
    <section id="faq" ref={sectionRef} className="section-glow ambient-purple py-[80px] md:py-[160px] px-6 bg-[#0B0D14]">
      <script
        ...
        <div className="animate-on-scroll space-y-3">
          {faqs.map((faq, index) => (
            ...
            >
              ...
              >
                <p className="px-5 sm:px-7 pb-5 sm:pb-7 text-gray-300 leading-relaxed text-[0.9375rem]">
                  {faq.answer}
                </p>
              </div>
            </div>
