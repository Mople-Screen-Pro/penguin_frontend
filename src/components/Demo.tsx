          ...
          <div className="relative">
            ...
            <div className="relative mac-window">
              ...
              <div className="relative bg-gradient-to-br from-slate-900 to-slate-800 aspect-video overflow-hidden">
                ...
                {/* Gradient overlay */}
                <div className="absolute inset-0 bg-gradient-to-br from-sky-600/5 via-transparent to-indigo-600/5" />
                ...
                >
                  ...
                  <div className="p-4 space-y-4">
                    ...
                    <div className="grid grid-cols-4 gap-3">
                      <div className={`bg-slate-800/60 rounded-lg p-3 border transition-all duration-200 ${currentAnim.target === 'stats1' && isZoomed ? 'border-sky-400/50 ring-2 ring-sky-400/20' : 'border-slate-700/30'}`}>
                      ...
                      <div className={`bg-slate-800/60 rounded-lg p-3 border transition-all duration-200 ${currentAnim.target === 'stats2' && isZoomed ? 'border-sky-400/50 ring-2 ring-sky-400/20' : 'border-slate-700/30'}`}>
                    ...
                    <div className="grid grid-cols-3 gap-3">
                      {/* Chart */}
                      <div className={`col-span-2 bg-slate-800/60 rounded-lg p-3 border transition-all duration-200 ${currentAnim.target === 'chart' && isZoomed ? 'border-sky-400/50 ring-2 ring-sky-400/20' : 'border-slate-700/30'}`}>
                        <div className="text-[10px] text-slate-400 mb-3">Weekly Performance</div>
                        <div className="flex items-end justify-between h-20 gap-2">
                          {[40, 65, 45, 80, 55, 90, 70].map((h, i) => (
                            <div key={i} className="flex-1 flex flex-col items-center gap-1">
                              <div
                                className="w-full rounded-sm bg-gradient-to-t from-sky-500/80 to-indigo-500/80 transition-all duration-300"
                                style={{
                                  height: `${h}%`,
                      ...
                      {/* Recent activity */}
                      <div className={`bg-slate-800/60 rounded-lg p-3 border transition-all duration-200 ${currentAnim.target === 'recent' && isZoomed ? 'border-sky-400/50 ring-2 ring-sky-400/20' : 'border-slate-700/30'}`}>
                ...
                >
                  ...
                  <div
                    ...
                    style={{
                      ...
                      boxShadow: isZoomed ? '0 0 30px rgba(56, 189, 248, 0.5), inset 0 0 20px rgba(56, 189, 248, 0.1)' : 'none',
