...
const videos = [
  // Start-up
  {
    src: '/videos/integrations/stitch.mp4', label: 'Stitch', role: 'Data', category: 'Start-up',
  ...
  {
    src: '/videos/integrations/canva.mp4', label: 'Canva', role: 'Content Creators', category: 'Start-up',
  ...
  {
    src: '/videos/integrations/miro.mp4', label: 'Miro', role: 'Collaboration', category: 'Start-up',
  ...
  // Educator
  {
    src: '/videos/integrations/education.mp4', label: 'Education', role: 'Educators', category: 'Educator',
  ...
  // Social
  {
    src: '/videos/integrations/figma2.mp4', label: 'YouTube', role: 'Creators', category: 'Social',
  ...
  {
    src: '/videos/integrations/github.mp4', label: 'TikTok', role: 'Influencers', category: 'Social',
  ...
  {
    src: '/videos/integrations/vscode2.mp4', label: 'Instagram', role: 'Marketers', category: 'Social',
  ...
  // Work
  {
    src: '/videos/hero/hero.mp4', label: 'Notion', role: 'Product Managers', category: 'Work',
