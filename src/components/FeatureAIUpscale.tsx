    ...
    <section ref={sectionRef} className="py-[120px] md:py-[160px] px-5 bg-[#000]">
      <div className="max-w-[1240px] mx-auto">
        ...
        <div className="animate-on-scroll text-center mb-10 md:mb-14">
          ...
          <h2 className="text-[32px] md:text-[48px] lg:text-[62px] font-[650] text-white leading-[1.1] tracking-tight">
            Take every pixel further <span className="text-white/40">with AI Upscale.</span>
          </h2>
        </div>
        ...
        <div className="animate-on-scroll grid grid-cols-1 md:grid-cols-3 gap-4 max-w-[960px] mx-auto mt-10">
          <div className="p-5 rounded-xl bg-white/[0.03] border border-white/[0.06]">
            <div className="w-9 h-9 rounded-lg bg-amber-500/[0.08] flex items-center justify-center text-amber-400/60 mb-3">
