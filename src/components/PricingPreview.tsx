  ...
  return (
    <section ref={sectionRef} className="section-glow ambient-purple pt-[40px] pb-[60px] md:pt-[80px] md:pb-[100px] px-5 bg-[#0C0C14]">
      <div className="max-w-3xl mx-auto text-center">
        ...
        <p className="animate-on-scroll text-sm sm:text-base text-white/50 mb-12 max-w-lg mx-auto">
        ...
        <div className="animate-on-scroll grid grid-cols-1 md:grid-cols-2 gap-4 max-w-2xl mx-auto mb-10">
          ...
          <div className="glass-card p-7 text-left">
            <span className="text-xs font-bold text-white/40 tracking-widest uppercase mb-3 block">Free</span>
            <div className="text-3xl font-bold text-white mb-1">$0</div>
            <p className="text-sm text-white/50 mb-5">Forever free, no strings attached.</p>
          ...
          <div className="glass-card p-7 text-left !border-primary-500/30 relative overflow-hidden">
            ...
            <p className="text-sm text-white/50 mb-5">Billed yearly. Lifetime option available.</p>
            <ul className="space-y-2.5">
