  ...
  return (
    <div className="min-h-screen bg-white">
      <SEO
        ...
        description="Read the Terms of Service for Penguin, the macOS screen recording app with auto cursor zoom. Learn about usage rights, subscriptions, and policies."
        path="/terms"
        jsonLd={{
